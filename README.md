...
- Start at **1000 Hz polling** and increase only if frametime remains clean (see: [mouse%20faq.md](https://github.com/Tr1cksterL0ki/Project-L0ki/blob/main/content/peripherals/mouse%20faq.md)).

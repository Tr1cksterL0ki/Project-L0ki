...
- Expanded Windows baseline with Game Mode + windowed-game optimization references and clarified HAGS as an A/B test toggle.
- Expanded do-not-use list (security regressions, debloated OS images, timer folklore).

## 2026-02-10
- Initial import + rewrite pass (measurement-first, VALORANT-friendly).
